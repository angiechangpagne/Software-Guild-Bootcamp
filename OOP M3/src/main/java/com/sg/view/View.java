...
public class View {
    ...
    public void displayEntryBanner() {
        io.println("==============================");
        io.println("\tPandora's Box Vending Machine");
        io.println("==============================");
    }
    ...
    public void displayExitMessage() {
        io.println("Thanks for using Pandora's Box! The Universe thanks you!");
    }
