...
/**
 *
 * one implementation of the dao for dependency injection
 */
public class DaoFileImpl implements Dao {
    ...
    private void writeFile() throws PersistanceException {
        ...
        try (PrintWriter writer = new PrintWriter(FILE_NAME)) {
            ...
            throw new PersistanceException("Universe Cant find items");
        }
    }
    ...
    private void createDefaultItemSet() throws PersistanceException{
        ...
        VendableItem matches = new VendableItem("Matches",new BigDecimal("1.75"),3);
        VendableItem cigarette = new VendableItem("Cigarette",new BigDecimal("0.25"),10);
        VendableItem lighter = new VendableItem("lighter",new BigDecimal("1.00"),1);
        ...
        inventory.put(matches.getName(), matches);
