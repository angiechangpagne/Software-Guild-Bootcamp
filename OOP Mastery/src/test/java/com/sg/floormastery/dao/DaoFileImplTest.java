...
public class DaoFileImplTest {
    ...
    private LocalDate testDate = LocalDate.parse("12311984", DateTimeFormatter.ofPattern("MMdduuuu"));
    public DaoFileImplTest() {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("applicationContext.xml");
        dao = ctx.getBean("dao", DaoFileImpl.class);
        this.testOrder.setOrderNumber(1);
        this.testOrder.setCustomerName("Elon Musk");
        this.testOrder.setState("CA");
        this.testOrder.setTaxRate(testTaxRate);
        this.testOrder.setProductType("Investments");
    ...
    public void testAddOrder() throws Exception {
        ...
        testAdd.setCustomerName("Elon Musk");
        testAdd.setState("CA");
        testAdd.setProductType("Investments");
    ...
    public void testEditOrder() throws Exception{
        ...
        testEdit.setCustomerName("Eminem");
        testEdit.setProductType("Mutual Funds");
        testEdit.setState("TX");
    ...
    public void testProductList() throws Exception{
        ...
        testProducts.add("Mutual Funds");
        testProducts.add("Investments");
        testProducts.add("Stocks");
        testProducts.add("IRA Account");
