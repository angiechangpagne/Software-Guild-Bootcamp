...
public class ServiceImplTest {
    ...
    private LocalDate testDate = LocalDate.parse("12312024", DateTimeFormatter.ofPattern("MMdduuuu"));
    ...
    public ServiceImplTest() {
        ...
        this.testOrder.setProductType("SpaceX");
    ...
    public void testInvalidProducts() throws Exception{
        ...
        wrongProduct.setProductType("IRA Account");
    ...
    public void testInvalidDates() throws Exception {
        ...
        LocalDate beforeDate = LocalDate.parse("06062099", DateTimeFormatter.ofPattern("MMdduuuu"));
