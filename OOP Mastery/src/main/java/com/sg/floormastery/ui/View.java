...
public class View {
    ...
    public void displayWelcome() {
        io.print("Product Order Data Base, Welcome to Primerica Financial Services");
        io.print("=========================================");
    }
    ...
    public void displayMainMenu() {
        io.print("    <<Main Menu>>    ");
        io.print("*********************");
        io.print("1. Display Product Orders");
        io.print("2. Add an IBA Product Order");
        io.print("3. Edit a Product Order");
    ...
    public void displayDisplayMenu() {
        ...
        io.print("**************************");
        io.print("1. Find Product Orders By Their Date");
        io.print("2. Return To The Main Menu");
        io.print("**************************");
    }
    ...
    public void displayAddOrderMenu() {
        ...
        io.print("---State");
        io.print("---Financial Product Type");
    ...
    public Order getOrderInfo(List<String> states, List<String> products) {
        ...
        String name = io.readString("What is the client's name?");
    ...
    private void displayOrder(Order order) {
        io.print("Consumer Name: " + order.getCustomerName());
    ...
    public void displayNewOrUpdatedOrder(Order order) {
        io.print("Here is the product order, updated to memory:");
        io.print("*************************************************");
        displayOrder(order);
        io.print("*************************************************");
    ...
    public void displayOrdersByDate(List<Order> orders, LocalDate date) {
        io.print("Here are the product orders for date of" + date + ": ");
        io.print("*************************************");
        int count = 1;
    ...
    public Order editTheOrder(List<Order> orders, int choice,
        ...
        while (backToEdit) {
            ...
            io.print("***************************");
            io.print("1. Consumer Name: " + editOrder.getCustomerName());
            io.print("2. State: " + editOrder.getState());
            io.print("3. Financial Product Type: " + editOrder.getProductType());
            ...
            switch (editorChoice) {
                case 1:
                    String customer = io.readString("What is the new client's name?");
                ...
                case 3:
                    ...
                    int typeChoice = io.readInt("What is the new financial product?", 1, products.size());
